...
public class assginment1 {
	 ...
	 * 
	 * @param n
	 * @return returns a boolean to show if it is prime or not (true == prime ^
	 *         false == !prime)
	 */
	...
	/**
	 * 
	 * takes an integer parameter n and finds out how many prime numbers there are
	 * from 0 to the number n.
	 * 
	 * @param n
	 * @return
	 */
