...
//
//	/**
//	 * Constructs a new queue. Chooses a circular linked list as an implementation
//	 * of a position-based list.
//	 */
...
//			return;
//		}
//		this.list.addAfter(this.list.getLast(), element);
//	}
//
//	/**
...
//			throw new EmptyDequeException();
//		}
//		// T result = this.list.getFirst().getElement();
...
//			throw new EmptyDequeException();
//		}
//		// T result = this.list.getLast().getElement();
...
//
///**
// * DO NOT MODIFY Interface for the double ended queue.
// */
//interface Deque<T> {
//	/**
...
//
///**
// * DO NOT MODIFY Interface for a node based list.
// *
...
//
///**
// * DO NOT MODIFY Interface that represents a node in the list.
// *
